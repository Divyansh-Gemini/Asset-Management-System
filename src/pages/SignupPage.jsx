        ...
        <div className="p-8 w-2/3">
          ...
          <form>
            <div className="mb-4">
              ...
              <input type="text" id="name" className="w-full px-4 py-2 border border-gray-300 rounded-2xl focus:outline-none focus:border-blue-500" />
            </div>
            <div className="mb-4">
              <label htmlFor="email" className="block text-gray-700 font-bold mb-2">Email</label>
              <input type="email" id="email" className="w-full px-4 py-2 border border-gray-300 rounded-2xl focus:outline-none focus:border-blue-500" />
            </div>
            <div className="mb-6">
            ...
            <button type="submit" className="bg-blue-500 mb-3 text-white px-4 w-full py-2 rounded-2xl hover:bg-blue-600 focus:outline-none focus:bg-blue-600">SignUp</button>
