  ...
  useEffect(() => {
    async function fetchData() {
      const response = await axios(
        "http://localhost:5000/api/v1/asset/get-all-assets"
      );
            ...
            <div className="mb-10 " key={asset._id}>
              <div className="flex bg-[#ace5f1] rounded-t-xl  ">
                ...
                <div className="px-6 py-4 ">
                  ...
                  <p className="text-gray-700 text-base">{asset.description}</p>
              ...
              <div className="p-3 px-6 flex justify-end bg-[#ace5f1] rounded-b-xl ">
                <button
                  className="bg-gradient-to-r from-[#E73361] to-[#F3564A] rounded-md hover:bg-opacity-90 focus:outline-none hover:ring-2 hover:ring-[#E73361] hover:border-transparent text-white font-bold py-2 px-2 w-24 mr-2"
                  onClick={() => {
                    handleEdit(asset._id);
                  }}
                >
                  Edit
                </button>
                <button
                  className="bg-gradient-to-r from-[#E73361] to-[#F3564A] rounded-md hover:bg-opacity-90 focus:outline-none hover:ring-2 hover:ring-[#E73361] hover:border-transparent text-white font-bold mr-2 w-24"
                  onClick={() => {
