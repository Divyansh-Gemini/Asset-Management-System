...
const CardView = () => {
  return (
    <div className="w-1/2 rounded overflow-hidden shadow-lg mx-auto bg-white text-black">
      <div className="flex">
        <img
          className="w-1/3 mx-10 mt-10 my-auto"
          src="assets/images/cardview.jpg"
          alt="Image"
        />
        <div className="px-6 py-4">
          <div className="font-bold text-xl mb-2 mt-5">Auditorium</div>
          <p className="text-gray-700 text-base">
            Auditorium is fully AC and there is capacity of 500 students
          </p>
